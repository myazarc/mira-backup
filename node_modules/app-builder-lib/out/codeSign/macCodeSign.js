...
function downloadCertificate(_x6, _x7, _x8) {
...
function _createKeychain() {
  _createKeychain = (0, _bluebirdLst().coroutine)(function* ({
    ...
    _bluebirdLst().default.map(certLinks, (link, i) => downloadCertificate(link, tmpDir, currentDir).then(it => certPaths[i] = it)), _bluebirdLst().default.mapSeries(securityCommands, it => (0, _util().exec)("security", it))]);
    return yield importCerts(keychainFile, certPaths, [cscKeyPassword, cscIKeyPassword].filter(it => it != null));
  });
  return _createKeychain.apply(this, arguments);
}

function importCerts(_x11, _x12, _x13) {
...
function getValidIdentities(_x14) {
...
function _findIdentity(_x15, _x16, _x17) {
