  ...
  sign(appPath, outDir, masOptions) {
    ...
    return (0, _bluebirdLst().coroutine)(function* () {
      ...
      if (identity == null) {
        ...
        if (identity == null) {
          yield (0, _macCodeSign().reportError)(isMas, certificateType, qualifier, keychainName, _this3.forceCodeSigning);
          return;
        }
      }
      ...
      if (masOptions != null && !isDevelopment) {
        ...
        const masInstallerIdentity = yield (0, _macCodeSign().findIdentity)(certType, masOptions.identity, keychainName);
