...
function createFrameworkInfo(_x, _x2) {
  return _createFrameworkInfo.apply(this, arguments);
}

function _createFrameworkInfo() {
  _createFrameworkInfo = (0, _bluebirdLst().coroutine)(function* (configuration, packager) {
...
class Packager {
  ...
  _build(configuration, metadata, devMetadata, repositoryInfo) {
    ...
    return (0, _bluebirdLst().coroutine)(function* () {
      ...
      const commonOutDirWithoutPossibleOsMacro = path.resolve(_this3.projectDir, (0, _macroExpander().expandMacro)(configuration.directories.output, null, _this3._appInfo, {
        os: ""
      }));
      ...
      const platformToTargets = yield (0, _promise().executeFinally)(_this3.doBuild(),
      /*#__PURE__*/
      (0, _bluebirdLst().coroutine)(function* () {
        if (_this3.debugLogger.isEnabled) {
          yield _this3.debugLogger.save(path.join(commonOutDirWithoutPossibleOsMacro, "builder-debug.yml"));
        }
    ...
    return (0, _bluebirdLst().coroutine)(function* () {
      ...
      for (const [platform, archToType] of _this5.options.targets) {
        ...
        for (const [arch, targetNames] of (0, _targetFactory().computeArchToTargetNamesMap)(archToType, packager.platformSpecificBuildOptions, platform)) {
          ...
          const outDir = path.resolve(_this5.projectDir, packager.expandMacro(_this5._configuration.directories.output, _builderUtil().Arch[arch]));
