...
class PlatformPackager {
  ...
  doPack(outDir, appOutDir, platformName, arch, platformSpecificBuildOptions, targets) {
    ...
    return (0, _bluebirdLst().coroutine)(function* () {
      ...
      if (framework.beforeCopyExtraFiles != null) {
        yield framework.beforeCopyExtraFiles({
          packager: _this3,
          appOutDir,
          asarIntegrity: asarOptions == null ? null : yield (0, _integrity().computeData)(resourcesPath, asarOptions.externalAllowed ? {
      ...
      if (framework.afterPack != null) {
        yield framework.afterPack(packContext);
      }

      const isAsar = asarOptions != null;
      yield _this3.sanityCheckPackage(appOutDir, isAsar, framework);
  ...
  checkFileInPackage(resourcesDir, file, messagePrefix, isAsar) {
    ...
    return (0, _bluebirdLst().coroutine)(function* () {
      ...
      if (pathParsed.dir.includes(".asar")) {
        ...
        const outStat = yield (0, _fs().statOrNull)(fullPath);
  ...
  sanityCheckPackage(appOutDir, isAsar, framework) {
    var _this7 = this;
    ...
    return (0, _bluebirdLst().coroutine)(function* () {
      ...
      const mainFile = (framework.getMainFile == null ? null : framework.getMainFile(_this7.platform)) || _this7.info.metadata.main || "index.js";
      yield _this7.checkFileInPackage(resourcesDir, mainFile, "Application entry file", isAsar);
  ...
  getOrConvertIcon(format) {
    ...
    return (0, _bluebirdLst().coroutine)(function* () {
      const result = yield _this9.resolveIcon((0, _builderUtil().asArray)(_this9.platformSpecificBuildOptions.icon || _this9.config.icon), [], format);
      ...
      if (result.length === 0) {
        ...
        return _this9.getDefaultFrameworkIcon();
      } else {
  ...
  resolveIcon(sources, fallbackSources, outputFormat) {
    ...
    return (0, _bluebirdLst().coroutine)(function* () {
      ...
      const result = yield (0, _appBuilder().executeAppBuilderAsJson)(args);
