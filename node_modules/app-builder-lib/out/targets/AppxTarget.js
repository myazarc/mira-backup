...
class AppXTarget extends _core().Target {
  ...
  build(appOutDir, arch) {
    ...
    return (0, _bluebirdLst().coroutine)(function* () {
      ...
      yield _this.writeManifest(manifestFile, arch, (yield _this.computePublisherName()), userAssets);
  ...
  computePublisherName() {
    ...
    return (0, _bluebirdLst().coroutine)(function* () {
      ...
      const certInfo = yield _this2.packager.lazyCertInfo.value;
  ...
  writeManifest(outFile, arch, publisher, userAssets) {
    var _this3 = this;
    ...
    return (0, _bluebirdLst().coroutine)(function* () {
      ...
      const manifest = (yield (0, _fsExtraP().readFile)(path.join((0, _pathManager().getTemplatePath)("appx"), "appxmanifest.xml"), "utf8")).replace(/\${([a-zA-Z0-9]+)}/g, (match, p1) => {
        switch (p1) {
          case "publisher":
            return publisher;
          ...
          case "extensions":
            return _this3.getExtensions(executable, displayName);
