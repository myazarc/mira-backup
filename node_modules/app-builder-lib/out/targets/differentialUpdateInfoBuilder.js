...
function appendBlockmap(_x) {
  return _appendBlockmap.apply(this, arguments);
}

function _appendBlockmap() {
  _appendBlockmap = (0, _bluebirdLst().coroutine)(function* (file) {
    _builderUtil().log.info({
      file: _builderUtil().log.filePath(file)
    }, "building embedded block map");

    return yield (0, _appBuilder().executeAppBuilderAsJson)(["blockmap", "--input", file, "--compression", "deflate"]);
  });
  return _appendBlockmap.apply(this, arguments);
}

function createBlockmap(_x2, _x3, _x4, _x5) {
  return _createBlockmap.apply(this, arguments);
} function _createBlockmap() {
  _createBlockmap = (0, _bluebirdLst().coroutine)(function* (file, target, packager, safeArtifactName) {
    ...
    const updateInfo = yield (0, _appBuilder().executeAppBuilderAsJson)(["blockmap", "--input", file, "--output", blockMapFile]);
