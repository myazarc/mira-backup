    ...
    return (0, _bluebirdLst().coroutine)(function* () {
      ...
      if (preCompressedFileExtensions != null && preCompressedFileExtensions.length !== 0) {
        for (const [arch, dir] of _this8.archs.entries()) {
          yield generateForPreCompressed(preCompressedFileExtensions, dir, arch, scriptGenerator);
        }
      }
...
function generateForPreCompressed(_x2, _x3, _x4, _x5) {
  return _generateForPreCompressed.apply(this, arguments);
}

function _generateForPreCompressed() {
  _generateForPreCompressed = (0, _bluebirdLst().coroutine)(function* (preCompressedFileExtensions, dir, arch, scriptGenerator) {
    const resourcesDir = path.join(dir, "resources");
    const dirInfo = yield (0, _fs().statOrNull)(resourcesDir);
    ...
    const preCompressedAssets = yield (0, _fs().walk)(resourcesDir, (file, stat) => {
      if (stat.isDirectory()) {
...
function createPackageFileInfo(_x6) {
