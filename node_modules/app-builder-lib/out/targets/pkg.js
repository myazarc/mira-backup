...
class PkgTarget extends _core().Target {
  ...
  build(appPath, arch) {
    ...
    return (0, _bluebirdLst().coroutine)(function* () {
      ...
      const identity = (yield Promise.all([(0, _macCodeSign().findIdentity)(certType, options.identity || packager.platformSpecificBuildOptions.identity, keychainName), _this.customizeDistributionConfiguration(distInfoFile, appPath), _this.buildComponentPackage(appPath, componentPropertyListFile, innerPackageFile)]))[0];
  ...
  customizeDistributionConfiguration(distInfoFile, appPath) {
    ...
    return (0, _bluebirdLst().coroutine)(function* () {
      ...
      if (options.background != null) {
        const background = yield _this2.packager.getResource(options.background.file);
      ...
      const welcome = yield _this2.packager.getResource(options.welcome);
      ...
      const conclusion = yield _this2.packager.getResource(options.conclusion);
