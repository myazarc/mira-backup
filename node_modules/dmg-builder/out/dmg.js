...
class DmgTarget extends _appBuilderLib().Target {
  ...
  signDmg(artifactPath) {
    ...
    return (0, _bluebirdLst().coroutine)(function* () {
      ...
      let identity = yield (0, _macCodeSign().findIdentity)(certificateType, qualifier, keychainName);

      if (identity == null) {
        identity = yield (0, _macCodeSign().findIdentity)("Mac Developer", qualifier, keychainName);
...
function createStageDmg(_x, _x2, _x3) {
  return _createStageDmg.apply(this, arguments);
}

function _createStageDmg() {
  _createStageDmg = (0, _bluebirdLst().coroutine)(function* (tempDmg, appPath, volumeName) {
...
function computeAssetSize(_x4, _x5, _x6, _x7) {
  return _computeAssetSize.apply(this, arguments);
}

function _computeAssetSize() {
  _computeAssetSize = (0, _bluebirdLst().coroutine)(function* (cancellationToken, dmgFile, specification, backgroundFile) {
...
function customizeDmg(_x8, _x9, _x10, _x11) {
  return _customizeDmg.apply(this, arguments);
}

function _customizeDmg() {
  _customizeDmg = (0, _bluebirdLst().coroutine)(function* (volumePath, specification, packager, backgroundFile) {
...
function computeDmgEntries(_x12, _x13, _x14, _x15) {
  return _computeDmgEntries.apply(this, arguments);
} function _computeDmgEntries() {
  _computeDmgEntries = (0, _bluebirdLst().coroutine)(function* (specification, volumePath, packager, asyncTaskManager) {
    let result = "";
