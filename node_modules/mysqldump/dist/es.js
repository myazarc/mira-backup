...
var getTables = function (connection, dbName, restrictedTables, restrictedTablesIsBlacklist) {
...
var getTriggerDump = function (connection, dbName, options, tables) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        (yield connection.multiQuery(getSchemaMultiQuery.join('\n')))
            // mysql2 returns an array of arrays which will all have our one row
            .map(r => r[0])
            .forEach((res) => {
...
// eslint-disable-next-line complexity
var getDataDump = function (connectionOptions, options, tables, dumpToFile) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const connection = createConnection(all([connectionOptions, {
        ...
        const outFileStream = dumpToFile ? createWriteStream(dumpToFile, {
            flags: 'a',
            encoding: 'utf8',
        }) : null;
...
function main(inputOptions) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const options = all([defaultOptions, inputOptions]);
